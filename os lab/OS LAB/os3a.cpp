...
int main()
{
	...
	int mem[MB]={9500,7000,4500,8500,3000,9000,1000,5500,1500,500};
	vector<int> memutil(MB,0);
	double avgtp=0.0,avgif=0.0,avgwt=0.0,avgql=0.0;
	vector<int> jobcomp(NOJ,0),jobtomem(NOJ,-1),memtojob(MB,-1),jobtottime(NOJ,-1),memoccp(MB,0);
